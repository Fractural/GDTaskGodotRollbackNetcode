...
namespace Fractural.Tasks
{
    ...
    public partial struct GDTask
    {
        public static YieldAwaitable Yield()
        {
            ...
            return new YieldAwaitable(ProcessLoopTiming.Type);
        }

        public static YieldAwaitable Yield(IPlayerLoopTiming timing)
        {
            // optimized for single continuation
        ...
        {
            return new GDTask(YieldPromise.Create(ProcessLoopTiming.Type, cancellationToken, out var token), token);
        }

        public static GDTask Yield(IPlayerLoopTiming timing, CancellationToken cancellationToken)
        {
        ...
        {
            return new GDTask(NextFramePromise.Create(ProcessLoopTiming.Type, CancellationToken.None, out var token), token);
        }

        /// <summary>
        /// Similar as GDTask.Yield but guaranteed run on next frame.
        /// </summary>
        public static GDTask NextFrame(IPlayerLoopTiming timing)
        {
        ...
        {
            return new GDTask(NextFramePromise.Create(ProcessLoopTiming.Type, cancellationToken, out var token), token);
        }

        /// <summary>
        /// Similar as GDTask.Yield but guaranteed run on next frame.
        /// </summary>
        public static GDTask NextFrame(IPlayerLoopTiming timing, CancellationToken cancellationToken)
        {
        ...
        {
            return GDTask.Yield(ProcessLoopTiming.Type);
        }

        public static GDTask WaitForEndOfFrame(CancellationToken cancellationToken)
        {
            return GDTask.Yield(ProcessLoopTiming.Type, cancellationToken);
        }
        ...
        {
            return GDTask.Yield(PhysicsProcessLoopTiming.Type);
        }
        ...
        {
            return GDTask.Yield(PhysicsProcessLoopTiming.Type, cancellationToken);
        }

        public static GDTask DelayFrame(int delayFrameCount, IPlayerLoopTiming delayTiming = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (delayTiming == null) delayTiming = ProcessLoopTiming.Type;
        ...
        public static GDTask Delay(int millisecondsDelay, IPlayerLoopTiming delayTiming = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            var delayTimeSpan = TimeSpan.FromMilliseconds(millisecondsDelay);
            return Delay(delayTimeSpan, delayTiming, cancellationToken);
        }

        public static GDTask Delay(TimeSpan delayTimeSpan, IPlayerLoopTiming delayTiming = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Delay(delayTimeSpan, DelayType.DeltaTime, delayTiming, cancellationToken);
        }

        public static GDTask Delay(int millisecondsDelay, DelayType delayType, IPlayerLoopTiming delayTiming = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            var delayTimeSpan = TimeSpan.FromMilliseconds(millisecondsDelay);
            return Delay(delayTimeSpan, delayType, delayTiming, cancellationToken);
        }

        public static GDTask Delay(TimeSpan delayTimeSpan, DelayType delayType, IPlayerLoopTiming delayTiming = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (delayTiming == null) delayTiming = ProcessLoopTiming.Type;
        ...
        sealed class YieldPromise : IGDTaskSource, IPlayerLoopItem, ITaskPoolNode<YieldPromise>
        {
            ...
            public static IGDTaskSource Create(IPlayerLoopTiming timing, CancellationToken cancellationToken, out short token)
            {
        ...
        sealed class DelayPromise : IGDTaskSource, IPlayerLoopItem, ITaskPoolNode<DelayPromise>
        {
            ...
            public static IGDTaskSource Create(TimeSpan delayTimeSpan, IPlayerLoopTiming timing, CancellationToken cancellationToken, out short token)
            {
                if (cancellationToken.IsCancellationRequested)
                {
                    return AutoResetGDTaskCompletionSource.CreateFromCanceled(cancellationToken, out token);
    ...
    {
        readonly IPlayerLoopTiming timing;

        public YieldAwaitable(IPlayerLoopTiming timing)
        {
            this.timing = timing;
        }
        ...
        public readonly struct Awaiter : ICriticalNotifyCompletion
        {
            ...
            public Awaiter(IPlayerLoopTiming timing)
            {
                this.timing = timing;
            }
