...
namespace Fractural.Tasks
{
    ...
    public sealed class TimeoutController : IDisposable
    {
        ...
        readonly IPlayerLoopTiming delayTiming;
        readonly CancellationTokenSource originalLinkCancellationTokenSource;

        public TimeoutController(DelayType delayType = DelayType.DeltaTime, IPlayerLoopTiming delayTiming = null)
        {
        ...
        public TimeoutController(CancellationTokenSource linkCancellationTokenSource, DelayType delayType = DelayType.DeltaTime, IPlayerLoopTiming delayTiming = null)
        {
            if (delayTiming == null) delayTiming = ProcessLoopTiming.Type;
            this.timeoutSource = new CancellationTokenSource();
