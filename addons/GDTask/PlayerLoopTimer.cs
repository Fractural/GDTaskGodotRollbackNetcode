...
namespace Fractural.Tasks
{
    public abstract class PlayerLoopTimer : IDisposable, IPlayerLoopItem
    {
        ...
        protected PlayerLoopTimer(bool periodic, IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken, Action<object> timerCallback, object state)
        {
        ...
        public static PlayerLoopTimer Create(TimeSpan interval, bool periodic, DelayType delayType, IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken, Action<object> timerCallback, object state)
        {
#if DEBUG
            // force use Realtime.
        ...
        public static PlayerLoopTimer StartNew(TimeSpan interval, bool periodic, DelayType delayType, IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken, Action<object> timerCallback, object state)
        {
    ...
    sealed class DeltaTimePlayerLoopTimer : PlayerLoopTimer
    {
        ...
        public DeltaTimePlayerLoopTimer(TimeSpan interval, bool periodic, IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken, Action<object> timerCallback, object state)
    ...
    sealed class RealtimePlayerLoopTimer : PlayerLoopTimer
    {
        ...
        public RealtimePlayerLoopTimer(TimeSpan interval, bool periodic, IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken, Action<object> timerCallback, object state)
            : base(periodic, playerLoopTiming, cancellationToken, timerCallback, state)
        {
            ResetCore(interval);
        }
