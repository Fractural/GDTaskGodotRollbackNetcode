...
namespace Fractural.Tasks
{
    public partial struct GDTask
    {
        ...
        {
            return new SwitchToMainThreadAwaitable(ProcessLoopTiming.Type, cancellationToken);
        }

        /// <summary>
        /// If running on mainthread, do nothing. Otherwise, same as GDTask.Yield(timing).
        /// </summary>
        public static SwitchToMainThreadAwaitable SwitchToMainThread(IPlayerLoopTiming timing, CancellationToken cancellationToken = default)
        {
        ...
        {
            return new ReturnToMainThread(ProcessLoopTiming.Type, cancellationToken);
        }

        /// <summary>
        /// Return to mainthread(same as await SwitchToMainThread) after using scope is closed.
        /// </summary>
        public static ReturnToMainThread ReturnToMainThread(IPlayerLoopTiming timing, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public static void Post(Action action, IPlayerLoopTiming timing = null)
        {
    ...
    {
        readonly IPlayerLoopTiming playerLoopTiming;
        readonly CancellationToken cancellationToken;

        public SwitchToMainThreadAwaitable(IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken)
        {
        ...
        public struct Awaiter : ICriticalNotifyCompletion
        {
            ...
            public Awaiter(IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken)
            {
                this.playerLoopTiming = playerLoopTiming;
                this.cancellationToken = cancellationToken;
            }
    ...
    public struct ReturnToMainThread
    {
        ...
        public ReturnToMainThread(IPlayerLoopTiming playerLoopTiming, CancellationToken cancellationToken)
        {
            this.playerLoopTiming = playerLoopTiming;
            this.cancellationToken = cancellationToken;
        }
        ...
        public readonly struct Awaiter : ICriticalNotifyCompletion
        {
            ...
            public Awaiter(IPlayerLoopTiming timing, CancellationToken cancellationToken)
            {
                this.timing = timing;
                this.cancellationToken = cancellationToken;
            }
